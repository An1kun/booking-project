...
class HotelReviewsViewTests(TestCase):
    ...
    def test_hotel_reviews_view(self):
        hotel = Hotel.objects.create(name='Test Hotel',city='Test City',description='Test Description',photo='hotel_images/test.jpg')
    ...
    def test_delete_review_view(self):
        hotel = Hotel.objects.create(name='Test Hotel',city='Test City',description='Test Description',photo='hotel_images/test.jpg')
        review = Review.objects.create(hotel=hotel, user=User.objects.create_user(username='testuser', password='12345'), stars=5, content='Test Content')
